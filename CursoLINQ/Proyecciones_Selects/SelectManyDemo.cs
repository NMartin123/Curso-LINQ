        ...
        public void Ejemplo()
        {
            var personas =
                new List<Persona>()
                {
                    new Persona {
                        Nombre = "Eduardo",
                        Telefonos = { "123-456", "789-852" }
                    },
                    new Persona {
                        Nombre = "Nidia",
                        Telefonos = { "998-478", "568-222" }
                    },
                    new Persona {
                        Nombre = "Alejandro",
                        Telefonos = { "712-132" }
            ...
            var personasYNumeros =
                personas
                    .SelectMany(p => numeros,
                    (persona, numero) =>
                        new { Persona = persona, Numero = numero });
            ...
            var personasYTelefonos =
                personas
                    .SelectMany(p => p.Telefonos,
                    (persona, telefono) =>
                        new { Persona = persona, Telefono = telefono });
            ...
            // Sintaxis de queries
            var telefonos_2 =
                from p in personas from telefono in p.Telefonos select telefono;

            var personasYNumeros_2 =
                from p in personas
                from n in numeros select new { Persona = p, Numero = n };
        }
    }
}
